...
predicho y rebalancea. Ver el plan completo en
`../.claude/plans/` y el estudio de fuentes en [docs/fuentes.md](docs/fuentes.md).
...
- [ ] Fase 2: ingesta automatizada (XM, BanRep, DANE) + data layer histórico.
- [ ] Fase 3-9: features, modelos, backtesting, auto-recalibración, visual.
